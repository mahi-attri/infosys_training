...
def generate_visualizations(results, output_dir):
    ...
    try:
        ...
        plt.pie(pie_sizes, 
                ...
                autopct='%1.1f%%',
                startangle=90,
                textprops={'color': colors['dark_blue'], 'fontweight': 'bold'},
                explode=(0.1, 0))
        ...
        bar_colors = [colors['green'] if 'Accepted' in label or 'matched' in label.lower() 
                      else colors['red'] if 'Rejected' in label or 'mismatch' in label.lower() 
                      else colors['dark_blue'] for label in bar_labels]
        ...
        # Color mapping for bars (red for below 70, green for 70 and above)
        uid_bar_colors = [colors['red'] if i < 7 else colors['green'] for i in range(len(bucket_labels))]
        ...
        # Color mapping for bars (red for below 70, green for 70 and above)
        address_bar_colors = [colors['red'] if i < 7 else colors['green'] for i in range(len(bucket_labels))]
